...
namespace AssetInventory
{
    public sealed class ActionUI : BasicEditorUI
    {
        ...
        private void DrawStepsListItem(Rect rect, int index, bool isActive, bool isFocused)
        {
            ...
            for (int i = 0; i < step.StepDef.Parameters.Count; i++)
            {
                ...
                if (finalOptions != null)
                {
                    ...
                    int curIndex = 0;
                    if (finalType == StepParameter.ParamType.String) curIndex = finalOptions.FindIndex(o => o.Item2.stringValue == step.Values[i].stringValue);
                    ...
                    {
                        if (finalType == StepParameter.ParamType.String) step.Values[i].stringValue = finalOptions[newIndex].Item2.stringValue;
        ...
        public override void OnGUI()
        {
            ...
            _action.RunMode = (CustomAction.Mode)EditorGUILayout.EnumPopup("Run Mode", _action.RunMode);
